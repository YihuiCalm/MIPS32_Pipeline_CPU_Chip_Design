...
set top_module MIPS32_CPU_top
set synthesized_files ./src/syn/MIPS32_CPU_top_scan.v
set cell_lib ./src/syn/osu05_stdcells.v
set scan_lib ./src/syn/osu_scan.v 
set stil_file ./src/syn/MIPS32_CPU_top_scan.spf
